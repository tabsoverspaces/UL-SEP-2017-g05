...
%%%%%%
% EDIT PERSONAL INFORMATION OPERATIONS
%%%%%

%%%%%%%%%%%
%% phone number confirmation code operation
%%%%%%%%%%%
...
\item \textbf{Parameters:} User ID, New address line #1, New address line #2,
New address line #3
